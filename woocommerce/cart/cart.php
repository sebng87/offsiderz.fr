...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
				<th class="product-thumbnail"><?php _e( 'Photo', 'woocommerce' ); ?></th>
						...
						<td class="product-remove" data-title="<?php esc_attr_e( 'Remove', 'woocommerce' ); ?>">
							<?php
								echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
									'<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><span class="icon icon-close"></span></a>',
			...
			<tr>
				<td colspan="6" class="actions">
					...
					<!-- <button type="submit" class="btn btn-secondary" name="update_cart">
						<span><?//php esc_attr_e( 'Update cart', 'woocommerce' ); ?></span>
					</button> -->
